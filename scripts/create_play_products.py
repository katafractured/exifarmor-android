#!/usr/bin/env python3
"""
Create Google Play one-time IAP products for com.katafract.exifarmor.

Four products mirror the iOS StoreKit catalog:
  Pro  (non-consumable unlock, $3.99)
  Tip Small  ($1.99, consumable — consumption handled app-side)
  Tip Medium ($4.99, consumable)
  Tip Large  ($9.99, consumable)
...
PRODUCTS = [
    product(
        "com.katafract.exifarmor.pro",
        "ExifArmor Pro",
        "One-time Pro unlock: unlimited metadata strips, premium share extension, batch mode, custom strip options, and privacy report.",
        3, 99,
    ),
    product(
        "com.katafract.exifarmor.tip.small",
        "Small Tip",
        "A small tip to support ExifArmor development. Thank you!",
        1, 99,
    ),
    product(
        "com.katafract.exifarmor.tip.medium",
        "Medium Tip",
        "A medium tip to support ExifArmor development. Thank you!",
        4, 99,
    ),
    product(
        "com.katafract.exifarmor.tip.large",
        "Large Tip",
        "A generous tip to support ExifArmor development. Thank you!",
        9, 99,
    ),
]
